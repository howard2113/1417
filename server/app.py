'''
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# do this first: CREATE UNIQUE INDEX accounts_note_idx on public.off_street_parkings (parking_id, parking_method, parking_type, parking_register)
# start: python app.py
# don't forget revise the ecosystem.config.js
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'''
